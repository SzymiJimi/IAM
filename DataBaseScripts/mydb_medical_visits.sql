...
CREATE TABLE `medical_visits` (
  `idMedical_Visits` int(11) NOT NULL,
  `Visit_Date` varchar(45) NOT NULL,
  `Description` varchar(255) DEFAULT NULL,
  `User_idUser` int(11) NOT NULL,
  PRIMARY KEY (`idMedical_Visits`),
  KEY `fk_Medical_Visits_User1_idx` (`User_idUser`),
  CONSTRAINT `fk_Medical_Visits_User1` FOREIGN KEY (`User_idUser`) REFERENCES `user` (`idUser`) ON DELETE NO ACTION ON UPDATE NO ACTION
