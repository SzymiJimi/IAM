...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/*")
                .hasAnyRole("USER", "ADMIN", "AGENT", "CARSPECIALIST", "HEALTHSPECIALIST", "TRAVELSPECIALIST")
                .anyRequest().hasAnyRole("USER", "ADMIN", "AGENT", "CARSPECIALIST", "HEALTHSPECIALIST", "TRAVELSPECIALIST")
                .and()
                .exceptionHandling()
