...
/**
 * Polecenie dodania klienta, klasa implementuje interfejs CommandInterface co umożliwia podpięcie tego polecenia to systemu obsługi poleceń wykorzystującego
 * wzorzec command.
 */
