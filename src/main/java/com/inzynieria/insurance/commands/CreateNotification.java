...
/**
 * Polecenie zgłoszenia zdarzenia, klasa implementuje interfejs CommandInterface co umożliwia podpięcie tego polecenia to systemu obsługi poleceń wykorzystującego
 * wzorzec command.
 */
public class CreateNotification implements CommandInterface {
    /**
     ...
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(CreateNotification.class);

    public CreateNotification (Integer idCommand, String name){
