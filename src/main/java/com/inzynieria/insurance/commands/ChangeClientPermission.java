...
/**
 * Polecenie przeglądania zdarzeń, klasa implementuje interfejs CommandInterface co umożliwia podpięcie tego polecenia to systemu obsługi poleceń wykorzystującego
 * wzorzec command.
 */
public class ChangeClientPermission implements CommandInterface {
    /**
    ...
    public ChangeClientPermission (Integer idCommand, String name){
